          ...
          <tbody className="bg-gray-800">
            {data.map((order) => (
              <tr key={order.id} className="border-t border-gray-700">
                <td className="py-3 text-gray-300 text-sm pl-4">{order.id}</td>
                <td className="py-3 flex items-center text-sm">
                  <span className="text-gray-300">{order.name}</span>
                </td>
                <td className="py-3 text-gray-300 text-sm">{order.address}</td>
                <td className="py-3 text-gray-300 text-sm">{order.date}</td>
                <td className="py-3 text-gray-300 text-sm">{order.type}</td>
                <td className="py-3">
                  <span
