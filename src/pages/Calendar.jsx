...
const Calendar = ({ events: initialEvents }) => {
  ...
  return (
    <>
      ...
      <div className="flex bg-gray-900 text-white mt-5">
        <div className="w-1/4 pr-4 bg-gray-800 rounded-2xl p-4">
          <Link to="/add-event">
            <button className="bg-blue-500 text-sm text-white px-8 py-2 rounded-md flex items-center mb-4">
        ...
        <div className="w-3/4 ml-4 bg-gray-800 rounded-2xl p-4">
          ...
          {viewMode === "Month" && (
            <div className="grid grid-cols-7 gap-0 rounded-l-md rounded-r-md">
            ...
            <div className="bg-gray-800 p-4 rounded-lg max-w-md">
              ...
              <div className="flex">
                {[...Array(selectedEvent.attendees)].map((_, i) => (
                  <div
                    key={i}
                    className="w-8 h-8 bg-gray-700 rounded-full -ml-2 first:ml-0"
                  ></div>
                ))}
              </div>
            </div>
